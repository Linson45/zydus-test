...
import { LOAD_BO_DAILY_PLAN, LOAD_BO_DAILY_PLAN_FAIL, LOAD_BO_DAILY_PLAN_SUCCESS } from '../../actions';
...
export default (state = INITIAL_STATE, action) => {
  ...
  switch (type) {
    case LOAD_BO_DAILY_PLAN:
      return { ...state, loading: true, data: null };
    case LOAD_BO_DAILY_PLAN_SUCCESS:
