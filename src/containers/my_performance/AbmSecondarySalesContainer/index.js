...
import AbmSecondarySalesComponent from '../../../components/my_performance/AbmSecondarySalesComponent';
import { Role } from '../../../util/Constants';

class MyPerformanceAbmSecondarySalesContainer extends Component {
  constructor(props) {
    super(props);
    this.state = {
...
)(MyPerformanceAbmSecondarySalesContainer);
