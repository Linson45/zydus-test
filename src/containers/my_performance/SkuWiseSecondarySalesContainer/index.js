...
import SkuWiseSecondarySalesComponent from '../../../components/my_performance/SkuWiseSecondarySalesComponent';

class MyPerformanceSkuWiseSecondarySalesContainer extends Component {
  constructor(props) {
    super(props);
    this.state = {
    ...
    static navigationOptions = {
      title: 'SKU Wise Secondary Sales',
    };
    ...
    render() {
      ...
      return (
        <Container>
          <SkuWiseSecondarySalesComponent
            data={data}
            loading={loading}
...
)(MyPerformanceSkuWiseSecondarySalesContainer);
