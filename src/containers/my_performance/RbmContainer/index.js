...
import {
  ...
  loadMyPerformanceAbmSales, loadMyPerformanceRbmDetailing,
...
import { getAllAbm, getAllBo } from '../../../local-storage/helper/all';
import RbmContentComponent from '../../../components/my_performance/RbmContentComponent';
...
class MyPerformanceAbmContainer extends React.Component {
  constructor(props) {
    ...
    async componentDidMount() {
      ...
      const abms = await getAllAbm();
      this.setState({
        specialities, bos, abms, isBiologics
      });
    }
    ...
    loadData() {
      ...
      if (selectedAbm) {
        aggregatedFilter.selected_abm_code = selectedAbm.rep_code;
      }
      if (selectedGroupAbm) {
        aggregatedFilter.selected_abm_group_code = selectedGroupAbm.rep_code;
      }
      ...
      this.props.loadMyPerformanceRbmDetailing({
        filter: data,
        aggregatedFilter
      });
    }
    ...
    setSelectedBo = async (selectedBo) => {
      this.setState({ selectedBo, selectedAbm: null, selectedGroupAbm: null });
      this.loadData();
    };

    setSelectedAbm = async (selectedAbm) => {
      this.setState({ selectedBo: null, selectedAbm, selectedGroupAbm: null });
      this.loadData();
    };

    setSelectedGroupAbm = async (selectedGroupAbm) => {
      this.setState({ selectedBo: null, selectedAbm: null, selectedGroupAbm });
      this.loadData();
    };
    ...
    render() {
      ...
      const {
        ...
        boSelectedSpeciality, selectedBo, bos, abms, selectedAbm, selectedGroupAbm, isBiologics
      } = this.state;
      ...
      return (
        <RbmContentComponent
          ...
          selectedGroupAbm={selectedGroupAbm}
          setSelectedAbm={this.setSelectedAbm}
          setSelectedGroupAbm={this.setSelectedGroupAbm}
