...
import {
  Dimensions, FlatList, Text, TextInput, TouchableOpacity, View
} from 'react-native';
...
export default class AddDoctorModalComponent extends Component {
  constructor(props) {
    super(props);
  ...
  renderDoctors() {
    ...
    return (
      <View>
        {this.renderSearch()}
        <FlatList
          style={[initial === 1 ? { opacity: 0.3 } : {}, { height: Dimensions.get('window').height / 2 }]}
          data={doctors}
          renderItem={({ item }) => (
    ...
    renderBottom() {
      ...
      return (
        <View style={styles.bottomContainer}>
          ...
          <TouchableOpacity style={styles.nextButton} onPress={this.onSubmitAction}>
