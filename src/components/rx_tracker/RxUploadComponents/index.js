...
class RxUploadComponents extends Component {
  constructor(props) {
    super(props);
    this.state = { 
      isDoctorSelect: null,
  ...
  offlineSubmit(isIncomplete) {
    ...
    // const chemists =  this.state.isChemistSelectedArray
    //const pos = this.isProofOfSupplyArray
    var d = new Date();
    const MONTHS = [
      "JAN",
      "FEB",
  ...
  addChemistHandler() {
    ...
    // if (this.state.isDoctorSelect) {
    //   if (newArray.length < this.state.isDoctorSelect.chemist_code.length) {
    //     newArray.push('');
    //     this.setState({isChemistSelectedArray: newArray});
    //   }
    // }

    console.log('chemist list array', this.state.chemistListCount);
  }
  renderModal() {
    const { showPopup } = this.state;
    console.log(this.state.isRxUpload);
    return (
      <Modal
        style={{
        ...
        <View style={styles.modalContent}>
          <Image
            source={{ uri: this.state.isRxUpload.uri }}
            resizeMode="contain"
            style={{
  ...
  renderModal0(index) {
    ...
    return (
      <Modal
        ...
        <View style={styles.modalContent}>
          <Image
            source={{ uri: this.state.isProofOfSupplyArray[0].uri }}
            style={{
              width: (Dimensions.get('window').width * 8) / 9,
              height: (Dimensions.get('window').height * 6) / 9,
            }}
  ...
  renderModal2(index) {
    ...
    console.log(
      'Apsel render image',
      index,
      this.state.isProofOfSupplyArray[1].uri,
    );
    return (
      <Modal
        style={{
        ...
        <View style={styles.modalContent}>
          <Image
            source={{ uri: this.state.isProofOfSupplyArray[1].uri }}
            style={{
              width: (Dimensions.get('window').width * 8) / 9,
              height: (Dimensions.get('window').height * 6) / 9,
            }}
  ...
  renderModal3(index) {
    ...
    console.log(
      'Apsel render image',
      index,
      this.state.isProofOfSupplyArray[2].uri,
    );
    return (
      <Modal
        style={{
        ...
        <View style={styles.modalContent}>
          <Image
            source={{ uri: this.state.isProofOfSupplyArray[2].uri }}
            style={{
              width: (Dimensions.get('window').width * 8) / 9,
              height: (Dimensions.get('window').height * 6) / 9,
            }}
  ...
  renderModal4(index) {
    ...
    console.log(
      'Apsel render image',
      index,
      this.state.isProofOfSupplyArray[3].uri,
    );
    return (
      <Modal
        style={{
        ...
        <View style={styles.modalContent}>
          <Image
            source={{ uri: this.state.isProofOfSupplyArray[3].uri }}
            style={{
              width: (Dimensions.get('window').width * 8) / 9,
              height: (Dimensions.get('window').height * 6) / 9,
            }}
  ...
  renderModal5(index) {
    ...
    console.log(
      'Apsel render image',
      index,
      this.state.isProofOfSupplyArray[4].uri,
    );
    return (
      <Modal
        style={{
        ...
        <View style={styles.modalContent}>
          <Image
            source={{ uri: this.state.isProofOfSupplyArray[4].uri }}
            style={{
              width: (Dimensions.get('window').width * 8) / 9,
              height: (Dimensions.get('window').height * 6) / 9,
            }}
  ...
  proofOfsupplyList(selectPhotoTapped, index) {
    ...
    const { chemistData, isChemistSelectedArray } = this.state
    var chemistDataTemp = chemistData
    ...
    var filterChemistData = chemistDataTemp.filter((elem => !isChemistSelectedArrayTemp.find(({ chemist_code }) => chemist_code === elem.chemist_code)))
    return (
      <View
        style={{
          flex: 1,
        ...
        <Dropdown
          ...
          onChangeText={(value, item, data) => {
            ...
            console.log('Chemist drop', newArray);
            this.setState({ isChemistSelectedArray: newArray });
          }}
        />
        <View
          ...
          <TextInput
            ...
            onChangeText={value => {
              ...
              console.log('Data text input',newArray)
  ...
  renderData(user, selectPhotoTapped) {
    ...
    const { changeChemist } = this.props;
        ...
        <View
          ...
          <Dropdown
            ...
            onChangeText={(value, index, data) => {
              this.setState({ isDoctorSelect: data[index] });
              this.setState({ chemistData: data[index].chemist_code });
              console.log('Chemist Data', data[index].chemist_code)
            }}
          />
        </View>
        {this.state.isDoctorSelect !== null ? (
          <View
            style={{
              flex: 1,
              flexDirection: 'row',
            ...
            <Dropdown
              ...
              onChangeText={(value, index, data) => {
                this.setState({ isSkuSelect: data[index] });
              }}
            />
          </View>
        ) : null}

        {this.state.isSkuSelect !== null ? (
          <View
            style={{
              flex: 1,
              flexDirection: 'row',
...
export default RxUploadComponents;
