...
export default class CoverageComponent extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  renderHeader() {
    ...
    const { marketing_efforts, doc_coverage } = getHeaderInfo();
    return (
      <View style={styles.header}>
        <View style={styles.headerCardView}>
          ...
          <View style={{ ...styles.headerCard, backgroundColor: ColorStyle.blue }}>
            <Text style={styles.headerNumber}>{doc_coverage}</Text>
            <Text style={styles.headerSubText}>Coverage</Text>
          </View>
        ...
        >
          <CollapseHeader style={styles.headerStyle}>
            ...
            >
              ...
              <Text style={styles.headerRowSubText}>% Coverage</Text>
            </ImageBackground>
          </CollapseHeader>
          <CollapseBody>
            <ScrollView>
              {
                                    doctors.map((doctor, index) => {
                                      const {
                                        doc_code, mcr_no, doc_name, doc_spec, visit_category, bo_name, bo_code,
                                        marketing_efforts, days_last_abm_visit, days_last_bo_visit,
                                        days_last_rbm_visit
                                      } = doctor;
                                      ...
                                      return (
                                        ...
                                        >
                                          ...
                                          <Text style={styles.subText}># Days since last met</Text>
                                          <View style={styles.views}>
                                            <View style={styles.roundView}>
                                              <Text style={styles.marketingEfforts}>{priceFormatWithoutDecimal(marketing_efforts)}</Text>
                                              <Text style={styles.effortText}>Mktg Efforts</Text>
                                            </View>

                                            <View style={{ ...styles.roundView, marginLeft: 5 }}>
                                              <Text style={styles.romeEfforts}>{days_last_rbm_visit || '-'}</Text>
                                              <Text style={styles.effortText}>RBM</Text>
                                            </View>

                                            <View style={{ ...styles.roundView, marginLeft: 5 }}>
                                              <Text style={styles.romeEfforts}>{days_last_abm_visit || '-'}</Text>
                                              <Text style={styles.effortText}>ABM</Text>
                                            </View>

                                            <View style={{ ...styles.roundView, marginLeft: 5 }}>
                                              <Text style={styles.romeEfforts}>{days_last_bo_visit || '-'}</Text>
                                              <Text style={styles.effortText}>BO</Text>
                                            </View>
                                          </View>
                                        </TouchableOpacity>
                                      );
