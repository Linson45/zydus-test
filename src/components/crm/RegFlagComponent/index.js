...
export default class RegFlagComponent extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      ...
      <View style={styles.header}>
        <View style={styles.headerCardView}>
          ...
          <View style={{ ...styles.headerCard, backgroundColor: ColorStyle.blue }}>
            <Text style={styles.headerNumber}>0.0</Text>
            <Text style={styles.headerSubText}>% Rxers w/ Red Flags</Text>
          </View>
        ...
        >
          <CollapseHeader style={styles.headerStyle}>
            ...
            >
              ...
              <Text style={styles.headerRowSubText}>0.0% Rxers w/ Red Flags</Text>
            </ImageBackground>
          </CollapseHeader>
          <CollapseBody>
            <ScrollView>
              {
                                    doctors.map((doctor, index) => {
                                      const {
                                        doc_code, mcr_no, doc_name, doc_spec, visit_category, bo_name, bo_code, marketing_efforts
                                      } = doctor;
                                        ...
                                        >
                                          ...
                                          <View style={styles.views}>
                                            ...
                                            <View style={{ ...styles.roundView, marginLeft: 10 }}>
                                              <Text style={styles.romeEfforts}>0</Text>
