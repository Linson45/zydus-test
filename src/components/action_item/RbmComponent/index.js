...
import {
  Body, Card, Fab, Icon, Item, Input, ListItem
} from 'native-base';
import {
  ImageBackground,
  ScrollView,
...
class RbmComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedIndex: 0,
      ...
      return (
        <View style={styles.headerImg}>
          <View style={styles.cardTopContainer}>
            <Card
              style={{ ...styles.card, backgroundColor: this.getCardBgColor(0) }}
            >
              <TouchableOpacity
            ...
            <Card
              style={{ ...styles.card, backgroundColor: this.getCardBgColor(1) }}
            >
              <TouchableOpacity
            ...
            <Card
              style={{ ...styles.card, backgroundColor: this.getCardBgColor(2) }}
            >
              <TouchableOpacity
          ...
          <View style={styles.cardBottomContainer}>
            <Card
              style={{ ...styles.card, backgroundColor: this.getCardBgColor(3) }}
            >
              <TouchableOpacity
            ...
            <Card
              style={{ ...styles.card, backgroundColor: this.getCardBgColor(4) }}
            >
              <TouchableOpacity
                onPress={() => this.setState({ selectedIndex: 4 })}
              >
                <Text
                  style={{
                    ...styles.number,
            ...
            <Card
              style={{ ...styles.card, backgroundColor: this.getCardBgColor(5) }}
            >
              <TouchableOpacity
                onPress={() => this.setState({ selectedIndex: 5 })}
              >
                <Text
                  style={{
                    ...styles.number,
