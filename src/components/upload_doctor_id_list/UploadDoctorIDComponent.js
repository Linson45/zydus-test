...
class UploadDoctorIDComponent extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      searchQuery: '',
  ...
  displayJsxMessage() {
    const { user, onDoctorList } = this.props;
    ...
    return (
      ...
      >
        ...
        <Icon
          name="users"
          style={{
            color: ColorStyle.gradientColor,
            fontSize: 25,
          }}
          onPress={() => onDoctorList()}
        />
      </View>
    );
  }
...
export default withNavigation(UploadDoctorIDComponent);
