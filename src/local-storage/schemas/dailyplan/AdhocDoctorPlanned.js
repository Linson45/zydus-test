export const DAILY_PLAN_ADHOC_DOCTOR_PLANNED = 'dailyplan_adhoc_doctor_planned';

export const DailyPlanAdhocDoctorPlanned = {
  name: DAILY_PLAN_ADHOC_DOCTOR_PLANNED,
  properties: {
    from_date: 'string',
    rep_code: 'string',
    doc_code: 'string',
